CafMenuPredictiveModel
---
A research project aiming to develop a weather-based predictive model of the optimal menu in the PSHS-EVC cafeteria



### Code for the correlation analysis
``` python
